...
from foodie.utils import processData, toId, getRole
...
def restaurantDetails(request):
    ...
    if request.method == "POST":
        ...
        rest = Restaurant()
        try:
            rest = Restaurant.objects.create(user=request.user,name = name,address1 = address1,address2 = address2,zip = zip,tag = tag)
            ...
            messages.info(request,'Loss of uniquness. Cant save restaurant details. Try again')
